...
//   });    
  ...
  window.addEventListener('DOMContentLoaded', function() {
    ...
    const tabsContent = document.querySelectorAll('.body-tabs'),
            tabs = document.querySelectorAll('.tabs__title'),
            tabsParent = document.querySelector('.tabs__navigation');
            ...
            function hideTabContent() {
                    ...
                    tabsContent[i].classList.add('add');
                    tabsContent[i].classList.remove('remove');
                    tabs[i].classList.add('_tab-active');
                }
                ...
                showTabContent();
                    ...
                    tabsParent.addEventListener('click', function(event) {
                            ...
                            if(target && target.classList.contains('tabs__title')) {
                        tabs.forEach((item, i) => {
                            if (target == item) {
                                hideTabContent();
                                showTabContent(i);
